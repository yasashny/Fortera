...
internal fun AddCustomTokenLayout(
    ...
    Scaffold(
        ...
        Column(
            ...
            InputCard(
                value = state.input,
                onValueChange = { onIntent(Intent.InputChanged(it)) },
                            ...
                            .clickable(enabled = !state.isAdding) {
                                scope.launch {
                                    ...
                                    if (pasted.isNotEmpty()) {
                                        onIntent(Intent.InputChanged(pasted))
                                    }
                                }
                            },
            ...
            Button(
                onClick = { onIntent(Intent.AddClicked) },
...
@Composable
private fun VerificationSlot(state: State) {
...
@Composable
private fun AddCustomTokenLayoutIdlePreview() {
    ForteraTheme {
...
@Preview(showBackground = true)
@Composable
private fun AddCustomTokenLayoutVerifiedPreview() {
    ForteraTheme {
        AddCustomTokenLayout(
            state = State(
