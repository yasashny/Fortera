...
) : MviViewModel<AddCustomTokenState, AddCustomTokenIntent, AddCustomTokenEffect>(AddCustomTokenState()) {

    private var verificationJob: Job? = null

    override fun handleIntent(intent: AddCustomTokenIntent) {
        when (intent) {
            is AddCustomTokenIntent.InputChanged -> onInputChanged(intent.value)
            AddCustomTokenIntent.AddClicked -> onAddClicked()
        }
    }
        ...
        intent {
            ...
            launch {
                ...
                if (wallet == null) {
                    ...
                    sendEffect(AddCustomTokenEffect.ShowError(UiText.of(R.string.add_token_error_network)))
                    return@launch
                }
                ...
                sendEffect(AddCustomTokenEffect.NavigateBack)
            }
        }
    }
