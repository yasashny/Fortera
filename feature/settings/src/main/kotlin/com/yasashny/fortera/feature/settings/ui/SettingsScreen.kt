...
import com.yasashny.fortera.feature.settings.R
import com.yasashny.fortera.feature.settings.presentation.SettingsEffect
...
internal fun SettingsScreen() {
    ...
    MviContainer(
        ...
        onEffect = { effect ->
            when (effect) {
                is SettingsEffect.RequestBiometric -> {
